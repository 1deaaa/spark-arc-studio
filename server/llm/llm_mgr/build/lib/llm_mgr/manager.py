...
from ._paths import get_runtime_file_path
...
class AIManagerBase:
    ...
    def __init__(self, db_name: str = "llm_config.db"):
        db_path = get_runtime_file_path(db_name, seed_from_package=False)
        ...
        self.state_file = get_runtime_file_path("llm_mgr_state.json", seed_from_package=True)
        self._load_state()
    ...
    def admin_export_to_yaml(self) -> str:
        ...
        return save_default_platform_configs_raw(export_data)
