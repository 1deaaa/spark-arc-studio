...
| **4. 撰写**      | Screenplay / Script       | **Scriptwriter (执笔编剧)**              | 最终的“笔”。在结构框架内填充血肉，处理场景描述、动作指导与角色对白。                                     |
| **5. 质量保证**  | Script Doctor / Coverage  | **Critic (逻辑审核) & Style (文风克隆)** | 逻辑审核负责模拟苛刻的审稿人提供冲突或逻辑漏洞的专业反馈；文风克隆负责通过目标文风约束消除 AI 味高频词。 |
