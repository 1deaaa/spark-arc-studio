...
const tabs = [
  {
    id: 'ideation',
    label: '构思',
    icon: markRaw(Lightbulb),  // 灵感 - 与桌面端 world 页面统一
    view: 'world',
  ...
  },
  {
    id: 'planning',
    label: '策划',
    icon: markRaw(List),  // 大纲结构 - 与桌面端 structure 页面统一
    view: 'structure',
  ...
  },
  {
    id: 'production',
    label: '创作',
    icon: markRaw(SquarePen),  // 剧本创作 - 与桌面端 production 页面统一
    view: 'production',
...
.mobile-bottom-nav {
  ...
  left: 0;
  width: 100%;
  height: var(--mobile-bottom-nav-height, 60px); /* 安全高度，适配 iOS home indicator 需额外 padding */
