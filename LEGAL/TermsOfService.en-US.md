...
1.2 **Open Source (AGPL-3.0):** The source code is released under AGPL-3.0. You may run, copy, distribute, study, modify, and improve the software. If you modify SparkArc and make it available to users over a network, you must provide those users with the complete corresponding source code for that version and preserve copyright, license, and attribution notices. AGPL-3.0 does not grant rights to use the SparkArc name, logos, brand visuals, official instance identity, or upstream endorsement. Unless expressly permitted in writing, third parties must not operate white-label services, impersonate official services, or claim an AGPL exemption. **The software is provided "as is" without any warranty** — including implied warranties of merchantability, fitness for a particular purpose, or non-infringement. In no event shall the Copyright Holder be liable for any claims, damages, or other liability arising from the software or its use.
...
6.6 **Points, quotas, and redeem codes:** SparkArc may include points, quotas, redeem codes, or usage analytics. These features are provided as tools for model-usage accounting, internal cost allocation, quota management, and operational assistance. If a third-party operator uses them for paid credits, prepaid plans, packages, redemption, promotions, or other commercial scenarios, that operator is solely responsible for consumer rights, refunds, invoicing, taxes, payment channels, anti-fraud, data retention, advertising claims, and local regulatory compliance. Unless expressly confirmed in writing and listed as an official instance, any third-party points, redeem codes, packages, balances, or credit rights are not official SparkArc debt, commitments, support obligations, or guarantees.
