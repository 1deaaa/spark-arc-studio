  ...
  'zh-CN': {
    launcher: {
      ...
      localDeploy: {
        ...
        startButton: '启动本地后端',
        starting: '正在启动本地后端',
        help: '首次使用会下载项目和便携 Python，并自动安装依赖；整个过程可能需要几分钟。保持此窗口打开即可。',
        idle: '等待开始',
        running: '正在准备本地后端...',
        ready: '本地后端已就绪，正在进入工作台',
        failed: '启动失败',
        timeout: '本地后端启动超时。请查看日志，确认 Git、网络和防火墙状态后重试。',
        retry: '重试',
        close: '关闭',
      },
    },
  ...
  'en-US': {
    launcher: {
      ...
      localDeploy: {
        ...
        help: 'On first use, SparkArc downloads the project and a portable Python runtime, then installs dependencies automatically. This can take a few minutes; keep this window open.',
        idle: 'Ready to start',
        running: 'Preparing the local backend...',
        ready: 'Local backend is ready. Entering the workspace',
        failed: 'Startup failed',
        timeout: 'Timed out waiting for the local backend. Check the log, Git, network, and firewall, then retry.',
        retry: 'Retry',
        close: 'Close',
      },
    },
  ...
  'ja-JP': {
    launcher: {
      ...
      localDeploy: {
        ...
        help: '初回はプロジェクトとポータブル Python をダウンロードし、依存関係を自動でインストールします。数分かかる場合があるため、このウィンドウを開いたままにしてください。',
        idle: '開始待ち',
        running: 'ローカルバックエンドを準備しています...',
        ready: 'ローカルバックエンドの準備が完了しました。ワークスペースへ移動します',
        failed: '起動に失敗しました',
        timeout: 'ローカルバックエンドの起動待ちがタイムアウトしました。ログ、Git、ネットワーク、ファイアウォールを確認して再試行してください。',
        retry: '再試行',
        close: '閉じる',
      },
    },
  ...
  'ko-KR': {
    launcher: {
      ...
      localDeploy: {
        ...
        help: '처음 사용할 때는 프로젝트와 휴대용 Python 런타임을 내려받고 의존성을 자동 설치합니다. 몇 분 정도 걸릴 수 있으니 이 창을 열어 두세요.',
        idle: '시작 대기 중',
        running: '로컬 백엔드를 준비하고 있습니다...',
        ready: '로컬 백엔드가 준비되었습니다. 작업실로 이동합니다',
        failed: '시작 실패',
        timeout: '로컬 백엔드 시작 대기 시간이 초과되었습니다. 로그, Git, 네트워크, 방화벽 상태를 확인한 뒤 다시 시도하세요.',
        retry: '다시 시도',
        close: '닫기',
      },
    },
