...
def semantic_event_data(event: str, status: str | None = None, **extra: Any) -> Dict[str, str]:
    return {
        'event': event,
...
def on_stats(chars: int | float = 0, elapsed: float | int = 0, speed: float | int = 0, label: str = '', **extra: Any) -> Dict[str, Any]:
    payload: Dict[str, Any] = {
        'chars': chars,
        'elapsed': elapsed,
        'speed': speed,
