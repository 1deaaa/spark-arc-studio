...
> 
> 💖 **スポンサー＆パートナーシップ**：もしあなたが API プロキシプロバイダー、アグリゲーター、または GPU サプライヤーであれば、私たちの [**スポンサーとビジネス協力ガイド**](.github/SUPPORT.md)（※現在は中国語・英語のみ）をご覧ください。開発とテストに必要な API クレジットのご支援と引き換えに、セルフホストユーザー向けの「デフォルト設定配信」など、露出効果の高いプロモーションチャネルを提供しています。**プロジェクトの高速な開発とアップデートを維持するために、皆様のご支援を心よりお待ちしております。**
