...
from agents.routes.schemas import (
    _save_project_beat_sheet,
    _save_project_outline,
    _save_project_synopsis,
)
...
def test_structure_state_tracks_sources_and_invalidates_downstream(monkeypatch, tmp_path) -> None:
    ...
    _save_project_synopsis("7", "demo", "第一版梗概")
    _save_project_beat_sheet("7", "demo", "第一版节拍")
    _save_project_outline("7", "demo", "第一版大纲")
    ...
    _save_project_synopsis("7", "demo", "第二版梗概")
    state = load_structure_state("7", "demo")
...
def test_first_tracked_save_hydrates_existing_legacy_artifacts(monkeypatch, tmp_path) -> None:
    ...
    _save_project_synopsis("8", "legacy", "新梗概")
...
def test_new_project_starts_at_revision_one(monkeypatch, tmp_path) -> None:
    ...
    _save_project_synopsis("9", "new-project", "首版梗概")
