...
## 开发者本人写在最后
本项目从设计、开发、到测试，全程由我(Mournight)一人完成，所以难免有许多瑕疵。我平时很忙，欢迎各位积极参与维护。
...
我也希望每一位贡献者、部署者和社区成员都保留这种意识：SparkArc 的开放不是为了让人闭源套壳、抹去来源、拿社区成果单向牟利。请一起维护 AGPL 赋予用户和贡献者的权利：保留署名与许可，按要求公开对应源码，标明修改与来源，尊重品牌和官方实例边界。
